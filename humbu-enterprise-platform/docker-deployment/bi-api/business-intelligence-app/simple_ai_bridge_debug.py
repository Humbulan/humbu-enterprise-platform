    ...
    def do_GET(self):
        ...
        if self.path == '/':
            ...
            try:
                ...
                print(f"DEBUG: Dashboard data: {business_data}")
            except:
                response_data = {
                    "revenue": 32480.75,
                    "customers": 189,
    ...
    def do_POST(self):
        if self.path == '/ai/chat':
            ...
            try:
                ...
                print(f"DEBUG: AI Agent failed: {e}")
                business_responses = [
...
print("🚀 Starting DEBUG AI Bridge on port 8001...")
print("📱 Mobile apps can connect to: http://localhost:8001")
print("🔍 DEBUG MODE: All requests and responses will be logged")

with socketserver.TCPServer(("", 8001), AIBridgeHandler) as httpd:
    print("🎯 DEBUG AI Bridge is running and ready for mobile apps!")
    httpd.serve_forever()
