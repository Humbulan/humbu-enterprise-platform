...
<body>
    <div class="dashboard">
        <div class="header">
            ...
            <small>Last Updated: {enterprise_data.get('last_update', 'N/A')}</small>
        </div>
        
        <div class="metrics-grid">
            <div class="metric-card">
                <h3>📊 Productivity Score</h3>
                <h2>{enterprise_data.get('productivity_score', 'N/A')}</h2>
                <p>Average project progress</p>
            </div>
            
            <div class="metric-card">
                <h3>🎯 Focus Score</h3>
                <h2>{enterprise_data.get('focus_score', 'N/A')}</h2>
                <p>Business performance metric</p>
            </div>
            
            <div class="metric-card">
                <h3>📈 Revenue Growth</h3>
                <h2>{enterprise_data.get('enterprise_metrics', {{}}).get('revenue_growth', 'N/A')}%</h2>
                <p>Quarter-over-quarter</p>
            </div>
            
            <div class="metric-card">
                <h3>👥 Customer Acquisition</h3>
                <h2>{enterprise_data.get('enterprise_metrics', {{}}).get('customer_acquisition', 'N/A')}%</h2>
                <p>Monthly growth</p>
            </div>
        </div>
        ...
        <div class="enterprise-section">
            ...
            {self.generate_goals_html(enterprise_data.get('active_goals', []))}
        </div>
        
        <div class="enterprise-section">
            <h2>📋 Project Status</h2>
            {self.generate_projects_html(enterprise_data.get('project_status', {{}}))}
        </div>
        
        <div class="enterprise-section">
            <h2>🚀 Strategic Recommendations</h2>
            <p>{enterprise_data.get('social_strategy', 'No strategy available')}</p>
        </div>
    </div>
